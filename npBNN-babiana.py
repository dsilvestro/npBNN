...
f= "/Users/dsilvestro/Software/npBNN/babiana/Training_BNNTraits_20Traits.txt"
l= "/Users/dsilvestro/Software/npBNN/babiana/Labels_Babiana_missForest.txt"
dat = BNN_files.get_data(f,l,seed=rseed,testsize=0.3) # 10% test set
...
mcmc = BNN_env.MCMC(bnn,update_f=[0.2, 0.2, 0.2, 0.2], update_ws=[0.075, 0.075, 0.075],
                 temperature = 2, n_iteration=100000, sampling_f=100, print_f=1000, n_post_samples=100,
